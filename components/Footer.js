  ...
  <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
      ...
      <div className="md:max-w-md lg:col-span-2">
        ...
        <a href="#" className="py-4 text-gray-500 inline-flex">
          <div className="py-2">Technology Partner</div>
          <object data="images/digital-logo.svg" className="px-2" />
        </a>
      </div>
    </div>
    <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
      <ul className="flex space-x-5">
        <li className="text-sm text-gray-500">Terms of Use</li>
        <li className="text-sm text-gray-500">Advertise with us</li>
        <li className="text-sm text-gray-500">License Footage</li>
        <li className="text-sm text-gray-500">Sitemap</li>
